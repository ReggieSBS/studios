            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  ...
                  <li class="actionbar_item" aria-current="page" data-bs-toggle="tooltip" title="Analyze this page">
                    <button class="btn btn-success text-white" type="button" data-bs-toggle="modal" data-bs-target="#pageAI"><i class="mdi mdi-robot"></i></button>
                  </li>
                        ...
                        @if(count($pagecharacters) > 0)
                          ...
                          <td style="text-align: left;">
                            ...
                            <a href="/character/{{ $pagecharacter[0]['id'] }}">
                              <img src="{{ $pagecharacter[0]['profile_image'] }}" width="30" style="border-radius:50%;" alt="{{ $pagecharacter[0]['name'] }}" bis_skin_checked="1" data-bs-toggle="tooltip" title="{{ $pagecharacter[0]['name'] }}">
